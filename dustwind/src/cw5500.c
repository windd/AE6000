...
void Write_W5500_1Byte(unsigned short reg, unsigned char dat)
{
    ...
    SPI1_Send_Short(reg);//通过SPI2写16位寄存器地址
    SPI1_Send_Byte(FDM1 | RWB_WRITE | COMMON_R); //通过SPI2写控制字节,1个字节数据长度,写数据,选择通用寄存器
...
void Write_W5500_2Byte(unsigned short reg, unsigned short dat)
{
    ...
    SPI1_Send_Short(reg);//通过SPI2写16位寄存器地址
    SPI1_Send_Byte(FDM2 | RWB_WRITE | COMMON_R); //通过SPI2写控制字节,2个字节数据长度,写数据,选择通用寄存器
...
void Write_W5500_nByte(unsigned short reg, unsigned char *dat_ptr, unsigned short size)
{
    ...
    SPI1_Send_Short(reg);//通过SPI2写16位寄存器地址
    SPI1_Send_Byte(VDM | RWB_WRITE | COMMON_R); //通过SPI2写控制字节,N个字节数据长度,写数据,选择通用寄存器
...
void Write_W5500_SOCK_1Byte(SOCKET s, unsigned short reg, unsigned char dat)
{
    ...
    SPI1_Send_Short(reg);//通过SPI2写16位寄存器地址
    SPI1_Send_Byte(FDM1 | RWB_WRITE | (s * 0x20 + 0x08)); //通过SPI2写控制字节,1个字节数据长度,写数据,选择端口s的寄存器
    SPI1_Send_Byte(dat);//写1个字节数据
...
void Write_W5500_SOCK_2Byte(SOCKET s, unsigned short reg, unsigned short dat)
{
    ...
    SPI1_Send_Short(reg);//通过SPI2写16位寄存器地址
    SPI1_Send_Byte(FDM2 | RWB_WRITE | (s * 0x20 + 0x08)); //通过SPI2写控制字节,2个字节数据长度,写数据,选择端口s的寄存器
    SPI1_Send_Short(dat);//写16位数据
...
void Write_W5500_SOCK_4Byte(SOCKET s, unsigned short reg, unsigned char *dat_ptr)
{
    ...
    SPI1_Send_Short(reg);//通过SPI2写16位寄存器地址
    SPI1_Send_Byte(FDM4 | RWB_WRITE | (s * 0x20 + 0x08)); //通过SPI2写控制字节,4个字节数据长度,写数据,选择端口s的寄存器
...
unsigned char Read_W5500_1Byte(unsigned short reg)
{
    ...
    SPI1_Send_Short(reg);//通过SPI2写16位寄存器地址
    SPI1_Send_Byte(FDM1 | RWB_READ | COMMON_R); //通过SPI2写控制字节,1个字节数据长度,读数据,选择通用寄存器
...
unsigned char Read_W5500_SOCK_1Byte(SOCKET s, unsigned short reg)
{
    ...
    SPI1_Send_Short(reg);//通过SPI2写16位寄存器地址
    SPI1_Send_Byte(FDM1 | RWB_READ | (s * 0x20 + 0x08)); //通过SPI2写控制字节,1个字节数据长度,读数据,选择端口s的寄存器
...
unsigned short Read_W5500_SOCK_2Byte(SOCKET s, unsigned short reg)
{
    ...
    SPI1_Send_Short(reg);//通过SPI2写16位寄存器地址
    SPI1_Send_Byte(FDM2 | RWB_READ | (s * 0x20 + 0x08)); //通过SPI2写控制字节,2个字节数据长度,读数据,选择端口s的寄存器
